...
with st.container(border=True, key='records_panel'):
    ...
    try:
        ...
        with col_stats:
            st.markdown(f"""
<div style="display:flex;gap:24px;justify-content:flex-end;align-items:center;padding-top:4px;">
  <div style="text-align:center;">
    <div style="font-family:var(--font-mono);font-size:9px;color:var(--muted);letter-spacing:.14em;margin-bottom:2px;">≡ 共計</div>
    <div style="font-family:var(--font-pixel);font-size:26px;color:var(--green);line-height:1;">{total:,}</div>
  </div>
  <div style="text-align:center;">
    <div style="font-family:var(--font-mono);font-size:9px;color:var(--muted);letter-spacing:.14em;margin-bottom:2px;">◎ 符合</div>
